...
const fillInStudentID = async driver => {
  ...
  studentIDtext.sendKeys('N15DCCN090');
};
...
const crawlSchedule = async () => {
  await restartDockerContainer();
  try {
    await getSchedulePage();
  } catch (error) {
    console.log('error :', error);
  }
};
